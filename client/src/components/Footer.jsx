        ...
        <footer>
            ...
            <div className="row">
                ...
                <div className="col-lg-6 text-right">
                    <span id="access">Accessibility</span>
                ...
                <div className="col-lg-4 col-xs-12">
                    ...
                    <ul>
                        <li>
                            ...
                            9724 Yonge Street, Richmond Hill, Canada
                        </li>
                        ...
                        <li>
                            ...
                            <a href="tel:+19055081111">(905) 508-1111</a>
                        </li>

                        <li>
                            <i className="fa fa-envelope"></i>
                            info@threecrownscanada.com
                        </li>
                    </ul>
                </div>
                ...
                <div className="col-lg-4 col-xs-12">
                    ...
                    <ul>
                        ...
                        <li>
                            ...
                            <a href="https://www.youtube.com/user/" target="_blank" rel="noreferrer">
                                YouTube
                            </a>
                        </li>
                    </ul>
